...
export default function CourseStatus() {
        return (
            <div id="wd-course-status" style={{ width: "350px" }}>
                    ...
                    <Button variant="secondary" className="w-100 mt-1 text-start">
                            <RiKanbanView   className="me-2 fs-5" /> Choose Home Page </Button>
                    <Button variant="secondary" className="w-100 mt-1 text-start">
                            <CiViewBoard  className="me-2 fs-5" /> View Course Stream </Button>
                    <Button variant="secondary" className="w-100 mt-1 text-start">
                    ...
                    <Button variant="secondary" className="w-100 mt-1 text-start">
                            <AiOutlineNotification  className="me-2 fs-5" /> View Course Notifications </Button>
            </div> );}